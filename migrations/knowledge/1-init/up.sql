...
-- deviation from the oracle v5 schema: the Go oracle overwrote chunk_text with the
...
--                              operational table; the Go oracle has no equivalent
--                              queue (it ingests synchronously), so no parity is
--                              required.
...
--                              table; the Go oracle has no equivalent (its vec0 store
--                              had no WAL), so no parity is required.
